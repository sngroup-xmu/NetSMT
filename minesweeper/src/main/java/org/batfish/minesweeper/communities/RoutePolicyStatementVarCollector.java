...
// ADD_BEGIN
// use enable flag to control collection of community (now only consider limited community policy type)
...
public class RoutePolicyStatementVarCollector
  ...
  public Set<CommunityVar> visitAddCommunity(AddCommunity addCommunity, Configuration arg) {
    if(Optimizations.ENABLE_MATCH_COMMUNITY_OPTIMIZATION){
