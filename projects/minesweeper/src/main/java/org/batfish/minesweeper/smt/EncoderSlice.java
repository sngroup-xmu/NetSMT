...
//            System.out.println("Potential!! For Dbest, Router:" + router +" receives " + proto + " edge:" + e.getEdge());
            ...
            // ADD_BEGIN
            // change condition from "<" to ">", since dbest store routes from customer
            boolean fromcustomer =  (g.getOtherEnd().get(e.getEdge()) == null) ||
...
//            System.out.println("For Dbest, Router:" + router +" receives " + proto + " edge:" + e.getEdge());
          ...
          // ADD_BEGIN
          // add dbest default constraint
          // todo: connected does not equals network
          if(!hasCustomer){
            add(mkEq(dbestVars.getPermitted(),mkFalse()));
          }
          // ADD_END
...
//                  System.out.println("For router:" + router + "|Export at graph edge:" + ge + ". with "+ varsOther);
                  ...
                  // ADD_BEGIN
                  // change condition from ">" to "<", only send provider route that from dbset
